...
export class StorageProfile extends DurableObject {
  run() {
    ...
    const config = { provider: "openai", modelId: "gpt-5.6-sol",
      accountId: "11111111-1111-4111-8111-111111111111", machineId: "22222222-2222-4222-8222-222222222222", executionGatewayUrl: "https://gateway.test", executionToken: `me1.22222222-2222-4222-8222-222222222222.1.${"x".repeat(43)}`, cwd: "/tmp" };
