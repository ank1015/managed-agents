// OpenAI Codex fixture scenarios, Copyright 2025 OpenAI, Apache-2.0.
// Source: OpenAI Codex 23a6b705bac7b849517946b3f1098380e214fd5c,
// codex-rs/apply-patch/tests/fixtures/scenarios (unmodified reference checkout).
// Repacked as TypeScript data; file contents/patches/expected bytes are unchanged.
// License: ../../../../packages/contracts/third-party/codex/LICENSE.
// Excludes 015 (our all-files preflight is intentionally different) and
// 023/024 (upstream opt-in line-ending preservation is not exposed).
export interface CodexScenario { name: string; input: Record<string, string>; patch: string; expected: Record<string, string> }
export const codexScenarios: CodexScenario[] = [
  {
    "name": "001_add_file",
    "input": {},
    "patch": "*** Begin Patch\n*** Add File: bar.md\n+This is a new file\n*** End Patch\n",
