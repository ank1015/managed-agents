...
test("submission rejects injected callback routing and excessive transport size", () => {
  const value = { execution: { gatewayUrl: "https://gateway.test", token: `me1.${input.machineId}.1.${"x".repeat(43)}`, runtimeGeneration: "00000000-0000-4000-8000-000000000002" }, destination: { routeKey: "test-v1", sessionId: "session" },
